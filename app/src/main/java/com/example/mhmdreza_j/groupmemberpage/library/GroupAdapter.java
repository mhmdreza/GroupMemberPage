package com.example.mhmdreza_j.groupmemberpage.library;
...
public class GroupAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    @NonNull
    private final Map<Integer, ViewTypeInfo> generateViewTypeToViewTypeInfoMap; // (generate viewType , ViewTypeInfo(adapter position, viewType))
    @NonNull
